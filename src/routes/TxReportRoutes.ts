...
import { TxSellMonthReportRequestDto, 
	TxSellRangeReportRequestDto } from '@src/Dto/TxSellDto';
...
router.post(Paths.report.TxSell.Base + '/' + Paths.report.TxSell.GetByDate, 
	validate(['startDate', 'date'], ['endDate', 'date']),
...
router.post(Paths.report.TxSell.Base + '/' + Paths.report.TxSell.GetByMonth, 
	validate(['date', 'date']), 
