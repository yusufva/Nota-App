...
import {
    NewProductMasterRequestDto,
    NewProductMasterResponseDto,
    ProductMasterResponseDto,
} from "@src/Dto/ProductMasterDto";
...
async function CreateNewProduct(
    product: NewProductMasterRequestDto
): Promise<NewProductMasterResponseDto> {
