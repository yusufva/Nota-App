...
import { NewStockRequestDto, NewStockResponseDto, StockResponseDto } from '@src/Dto/StockDto';
...
async function UpdateStockById(product: NewStockRequestDto, id:string): Promise<NewStockResponseDto> {
